...
router.post('/create', [authJwt.verifyToken, authJwt.isAdmin, upload.fileUpload('image')], product_controller.product_create);
router.put('/:id', [authJwt.verifyToken, authJwt.isAdmin, upload.fileUpload('image')], product_controller.product_update);
